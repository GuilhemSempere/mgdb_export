...
public class PhylipPseudoAlignmentExportHandler extends FastaPseudoAlignmentExportHandler {
    ...
    public String getExportFormatDescription() {
    	return "Exports a zipped PHYLIP file containing a pseudo-alignment consisting in the concatenation of SNP alleles. Compatible with phylogenetic tree construction tools like FastME";
    }
